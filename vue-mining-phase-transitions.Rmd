...
abstract: This document provides an overview of phase transitions in sofware repositories
  ...
  examining commit co-occurrence graphs, it shows how phae transitions take the repository
  to a critical state via self-organization.The main objective of this paper is to
  pove that commit co-occurrence graphs and its evolution are an adequate way to detect
